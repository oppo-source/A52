...
void dump_gcc_regs(void)
{
	u32 val;

	regmap_read(gcc_sys_noc_ufs_phy_axi_clk.clkr.regmap, 0x45004, &val);
	pr_err("UFS GDSCR 0x%x\n", val);

	WARN_CLK(gcc_ufs_mem_clkref_clk.clkr.hw.core, "gcc_ufs_mem_clkref_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_rx_symbol_0_clk.clkr.hw.core, "gcc_ufs_phy_rx_symbol_0_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_tx_symbol_0_clk.clkr.hw.core, "gcc_ufs_phy_tx_symbol_0_clk", 1, "dump register\n");
	WARN_CLK(gcc_sys_noc_ufs_phy_axi_clk.clkr.hw.core, "gcc_sys_noc_ufs_phy_axi_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_ahb_clk.clkr.hw.core, "gcc_ufs_phy_ahb_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_axi_clk.clkr.hw.core, "gcc_ufs_phy_axi_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_ice_core_clk.clkr.hw.core, "gcc_ufs_phy_ice_core_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_phy_aux_clk.clkr.hw.core, "gcc_ufs_phy_phy_aux_clk", 1, "dump register\n");
	WARN_CLK(gcc_ufs_phy_unipro_core_clk.clkr.hw.core, "gcc_ufs_phy_unipro_core_clk", 1, "dump register\n");
}
EXPORT_SYMBOL(dump_gcc_regs);
