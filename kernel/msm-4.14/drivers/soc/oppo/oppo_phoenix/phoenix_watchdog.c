...
/*ifdef VENDOR_EDIT*/
/* avtansh.gupta@BSP.Kernel.Drivers  20200817 intialize the pet time for phoenix project externally*/
void reinitialze_pet_time_for_aging_build(int pet_time)
{
    phx_hlos_wd_pet_time = pet_time; //aging test version
}
EXPORT_SYMBOL(reinitialze_pet_time_for_aging_build);
/* endif VENDOR_EDIT*/
