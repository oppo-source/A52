...
static int dsi_panel_power_on(struct dsi_panel *panel)
{
	int rc = 0;
	#ifdef VENDOR_EDIT
	//Kui.Feng@PSW.MM.Display.LCD.Stability, 2019/12/10, add for not loading tp fw in ftm mode.
	int mode = 0;
	#endif

	#ifdef VENDOR_EDIT
	/* Kui.Feng@PSW.BSP.TP.Function, 2019/12/12, Add for TP common code */
...
/* W9001377@MM.Display.Driver.Stability. 20191205 */
/* modify power off sequence */

        #ifdef VENDOR_EDIT
	//Kui.Feng@PSW.MM.Display.LCD.Stability, 2019/12/19, lcd reset pull low only when shutdown
	...
	#ifdef VENDOR_EDIT
        //Kui.Feng@PSW.MM.Display.LCD.Stability, 2019/12/19, add for lcd power off sequence
