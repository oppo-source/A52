 ...
 * VENDOR_EDIT
 * File       : novatek_drivers_nt36672a.c
 * Description: Source file for novatek nt36672a driver
 * Version   : 1.0
 * Date        : 2019/019/22
...
#include "nvt_drivers_nt36672a_noflash.h"
...
#define TPD_DEVICE "novatek,nf_nt36672a"
...
static int8_t nvt_cmd_store(struct chip_data_nt36672a *chip_info, uint8_t u8Cmd);
...
static struct chip_data_nt36672a *g_chip_info = NULL;
...
return:
    n.a.
*******************************************************/
void nvt_bootloader_reset_noflash(struct chip_data_nt36672a *chip_info)
{
    ...
    nvt_write_addr(chip_info->s_client, SPI_READ_FAST, 0x00);
}
...
return:
    Executive outcomes. 0---succeed. -5---access fail.
*******************************************************/
static int32_t nvt_set_page(struct chip_data_nt36672a *chip_info, uint32_t addr)
{
    uint8_t buf[4] = {0};
...
static uint8_t nvt_wdt_fw_recovery(struct chip_data_nt36672a *chip_info, uint8_t *point_data)
{
...
static void nvt_esd_check_update_timer(struct chip_data_nt36672a *chip_info)
{
    TPD_DEBUG("%s\n", __func__);
...
static void nvt_esd_check_enable(struct chip_data_nt36672a *chip_info, bool enable)
{
...
{
    struct chip_data_nt36672a *chip_info = (struct chip_data_nt36672a *)chip_data;
...
*******************************************************/
static int8_t nvt_ts_check_chip_ver_trim(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
    int32_t retry = 0;
    int32_t list = 0;
...
*******************************************************/
static int32_t nvt_check_fw_reset_state_noflash(struct chip_data_nt36672a *chip_info, RST_COMPLETE_STATE check_reset_state)
{
    uint8_t buf[8] = {0};
    int32_t ret = 0;
    int32_t retry = 0;
...
static int nvt_enter_sleep(struct chip_data_nt36672a *chip_info, bool config)
{
    int ret = -1;
...
*******************************************************/
static void nvt_read_pid_noflash(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[4] = {0};
...
static int32_t nvt_get_fw_info_noflash(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[64] = {0};
...
static int32_t nvt_bin_header_parser(struct chip_data_nt36672a *chip_info, const u8 *fwdata, size_t fwsize)
{
    uint32_t list = 0;
    uint32_t pos = 0x00;
...
return:
        n.a.
*******************************************************/
static int32_t Download_Init(struct chip_data_nt36672a *chip_info)
{
...
return:
        n.a.
*******************************************************/
static void nvt_read_ram_test(struct chip_data_nt36672a *chip_info, uint32_t addr, uint16_t len, char *name)
{
    char file[256] = "";
    uint8_t *fbufp = NULL;
    int32_t ret = 0;
...
*******************************************************/
/*
static int32_t Write_Partition(struct chip_data_nt36672a *chip_info, const u8 *fwdata, size_t fwsize)
{
    uint32_t list = 0;
...
static void nvt_bld_crc_enable(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[4] = {0};
...
return:
    N/A.
*******************************************************/
static void nvt_fw_crc_enable(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[4] = {0};
...
return:
        Executive outcomes. 0---succeed. -5---access fail.
*******************************************************/
static void nvt_boot_ready(struct chip_data_nt36672a *chip_info, uint8_t ready)
{
...
return:
        n.a.
*******************************************************/
static void nvt_eng_reset(struct chip_data_nt36672a *chip_info)
{
...
return:
	n.a.
*******************************************************/
static void nvt_set_bld_crc_bank(struct chip_data_nt36672a *chip_info,
...
return:
	n.a.
*******************************************************/
static void nvt_set_bld_hw_crc(struct chip_data_nt36672a *chip_info)
{
    /* [0] ILM */
    /* write register bank */
...
return:
    n.a.
*******************************************************/
static void nvt_read_bld_hw_crc(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
...
return:
        n.a.
*******************************************************/
static int32_t Download_Firmware_HW_CRC(struct chip_data_nt36672a *chip_info, const struct firmware *fw)
{
    uint8_t retry = 0;
    int32_t ret = 0;
...
int32_t nvt_nf_detect_chip(struct chip_data_nt36672a *chip_info)
{
    int32_t ret = 0;
    int i;
    uint8_t buf[8] = {0};
...
{
   int ret = -1;
    struct chip_data_nt36672a *chip_info = g_chip_info;
    const struct firmware *fw = NULL;
...
static void nova_write_log_buf(struct chip_data_nt36672a *chip_info, u8 main_id, u8 sec_id)
{
...
static void nova_debug_info(struct chip_data_nt36672a *chip_info, u8 *buf)
{
...
static int8_t nvt_extend_cmd_store(struct chip_data_nt36672a *chip_info, uint8_t u8Cmd, uint8_t u8SubCmd)
{
    int i, retry = 5;
    uint8_t buf[4] = {0};
...
static void nvt_read_debug_gesture_coordinate_buffer(struct chip_data_nt36672a *chip_info,
...
static void nvt_dbg_gesture_record_coor_read(struct chip_data_nt36672a *chip_info, u8 pointdata)
{
    u8 *xdata = NULL;
    uint32_t buf_len = 0;
...
#ifdef CONFIG_OPPO_TP_APK
static __maybe_unused int nvt_enable_debug_gesture_coordinate_record_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static __maybe_unused int nvt_enable_debug_gesture_coordinate_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static int nvt_enable_black_gesture(struct chip_data_nt36672a *chip_info, bool enable)
{
    int ret = -1;
...
static int nvt_enable_edge_limit(struct chip_data_nt36672a *chip_info, int state)
{
    int8_t ret = -1;
    struct touchpanel_data *ts = spi_get_drvdata(chip_info->s_client);
...
static int nvt_enable_charge_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static int nvt_enable_game_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static int nvt_enable_headset_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
#ifdef CONFIG_OPPO_TP_APK
static __maybe_unused int nvt_enable_hopping_polling_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static __maybe_unused int nvt_enable_hopping_fix_freq_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static __maybe_unused int nvt_enable_debug_msg_diff_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
static __maybe_unused int nvt_enable_water_polling_mode(struct chip_data_nt36672a *chip_info, bool enable)
{
    int8_t ret = -1;
...
*/
#else
	 strlcpy(&panel_data->manufacture_info.version[7],
                dev_version, MAX_DEVICE_VERSION_LENGTH - 7);
...
static int32_t nvt_clear_fw_status(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
    int32_t i = 0;
...
static void nvt_enable_noise_collect(struct chip_data_nt36672a *chip_info, int32_t frame_num)
{
    int ret = -1;
    uint8_t buf[8] = {0};
...
static int8_t nvt_switch_FreqHopEnDis(struct chip_data_nt36672a *chip_info, uint8_t FreqHopEnDis)
{
    uint8_t buf[8] = {0};
    uint8_t retry = 0;
    int8_t ret = 0;
...
static void nvt_change_mode(struct chip_data_nt36672a *chip_info, uint8_t mode)
{
    uint8_t buf[8] = {0};
...
static uint8_t nvt_get_fw_pipe_noflash(struct chip_data_nt36672a *chip_info)
{
    int ret = -1;
    uint8_t buf[8] = {0};
...
static void nvt_read_mdata(struct chip_data_nt36672a *chip_info, uint32_t xdata_addr, int32_t *xdata, int32_t xdata_len)
{
    int32_t i = 0;
    int32_t j = 0;
    int32_t k = 0;
...
#ifdef CONFIG_OPPO_TP_APK
static void nvt_read_debug_mdata(struct chip_data_nt36672a *chip_info,
...
static int32_t nvt_polling_hand_shake_status(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
    int32_t i = 0;
...
static int32_t nvt_check_fw_status(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
    int32_t i = 0;
    const int32_t retry = 50;
...
static uint8_t nvt_get_fw_pipe(struct chip_data_nt36672a *chip_info)
{
    int ret = -1;
    uint8_t buf[8] = {0};
...
static int32_t nvt_read_fw_noise(struct chip_data_nt36672a *chip_info, int32_t config_Diff_Test_Frame, int32_t *xdata, int32_t *xdata_n, int32_t xdata_len)
{
    uint32_t x = 0;
    uint32_t y = 0;
...
static void nvt_enable_doze_noise_collect(struct chip_data_nt36672a *chip_info, int32_t frame_num)
{
    int ret = -1;
    uint8_t buf[8] = {0};
...
static int32_t nvt_read_doze_fw_noise(struct chip_data_nt36672a *chip_info, int32_t config_Doze_Noise_Test_Frame, int32_t doze_X_Channel, int32_t *xdata, int32_t *xdata_n, int32_t xdata_len)
{
    uint8_t buf[128] = {0};
    uint32_t x = 0;
    uint32_t y = 0;
...
static int32_t nvt_read_doze_baseline(struct chip_data_nt36672a *chip_info, int32_t doze_X_Channel, int32_t *xdata, int32_t xdata_len)
{
    uint8_t buf[256] = {0};
    uint32_t x = 0;
    uint32_t y = 0;
...
{
    struct chip_data_nt36672a *chip_info;
    chip_info = (struct chip_data_nt36672a *)chip_data;
...
static void nvt_data_read(struct seq_file *s, struct chip_data_nt36672a *chip_info, DEBUG_READ_TYPE read_type)
{
    int ret = -1;
    int i, j;
    uint8_t pipe;
...
#ifdef CONFIG_OPPO_TP_APK
static void nvt_debug_data_read(struct seq_file *s, struct chip_data_nt36672a *chip_info, DEBUG_READ_TYPE read_type)
{
    int ret = -1;
    int i, j;
    //uint8_t pipe;
...
static void nvt_enable_short_test(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
...
static int32_t nvt_read_fw_short(struct chip_data_nt36672a *chip_info, int32_t *xdata, int32_t xdata_len)
{
...
static void nvt_enable_open_test(struct chip_data_nt36672a *chip_info)
{
    uint8_t buf[8] = {0};
...
static int32_t nvt_read_fw_open(struct chip_data_nt36672a *chip_info, int32_t *xdata, int32_t xdata_len)
{
    uint32_t raw_pipe_addr = 0;
    uint8_t *rawdata_buf = NULL;
    uint32_t x = 0;
...
{
    struct chip_data_nt36672a *chip_info = NULL;
    ...
    /* 1. alloc chip info */
    chip_info = kzalloc(sizeof(struct chip_data_nt36672a), GFP_KERNEL);
    if (chip_info == NULL) {
