...
static ssize_t power_shutdown_set(struct device *dev,
...
static DEVICE_ATTR(power_shutdown, S_IWUSR, NULL, power_shutdown_set);
...
static int fpc1020_probe(struct platform_device *pdev)
{
        ...
        int irqf;
        struct device_node *np = dev->of_node;
        struct regulator *fpc_regulator = NULL;
