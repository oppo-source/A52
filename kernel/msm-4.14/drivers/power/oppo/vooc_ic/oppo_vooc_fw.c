...
void oppo_vooc_fw_type_dt(struct oppo_vooc_chip *chip)
{
	...
	rc = of_property_read_u32(node, "qcom,vooc_strategy1_batt_up_down_temp1",
		&chip->vooc_strategy1_batt_up_down_temp1);
	if (rc) {
		chip->vooc_strategy1_batt_up_down_temp1  = chip->vooc_multistep_initial_batt_temp;
	} else {
		chg_debug("qcom,vooc_strategy1_batt_up_down_temp1 is %d\n",
			chip->vooc_strategy1_batt_up_down_temp1);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_batt_up_down_temp2",
		&chip->vooc_strategy1_batt_up_down_temp2);
	if (rc) {
		chip->vooc_strategy1_batt_up_down_temp2 = chip->vooc_multistep_initial_batt_temp;
	} else {
		chg_debug("qcom,vooc_strategy1_batt_up_down_temp2 is %d\n",
			chip->vooc_strategy1_batt_up_down_temp2);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_batt_up_temp3",
		&chip->vooc_strategy1_batt_up_temp3);
	if (rc) {
		chip->vooc_strategy1_batt_up_temp3 = chip->vooc_multistep_initial_batt_temp;
	} else {
		chg_debug("qcom,vooc_strategy1_batt_up_temp3 is %d\n",
			chip->vooc_strategy1_batt_up_temp3);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_batt_up_temp4",
		&chip->vooc_strategy1_batt_up_temp4);
	if (rc) {
		chip->vooc_strategy1_batt_up_temp4 = chip->vooc_multistep_initial_batt_temp;
	} else {
		chg_debug("qcom,vooc_strategy1_batt_up_temp4 is %d\n",
			chip->vooc_strategy1_batt_up_temp4);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_batt_up_temp5",
		&chip->vooc_strategy1_batt_up_temp5);
	if (rc) {
		chip->vooc_strategy1_batt_up_temp5 = chip->vooc_multistep_initial_batt_temp;
	} else {
		chg_debug("qcom,vooc_strategy1_batt_up_temp5 is %d\n",
			chip->vooc_strategy1_batt_up_temp5);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_high0_current",
		&chip->vooc_strategy1_high0_current);
	if (rc) {
		chip->vooc_strategy1_high0_current  = chip->vooc_strategy_normal_current;
	} else {
		chg_debug("qcom,vooc_strategy1_high0_current is %d\n",
			chip->vooc_strategy1_high0_current);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_high1_current",
		&chip->vooc_strategy1_high1_current);
	if (rc) {
		chip->vooc_strategy1_high1_current  = chip->vooc_strategy_normal_current;
	} else {
		chg_debug("qcom,vooc_strategy1_high1_current is %d\n",
			chip->vooc_strategy1_high1_current);
	}

	rc = of_property_read_u32(node, "qcom,vooc_strategy1_high2_current",
		&chip->vooc_strategy1_high2_current);
	if (rc) {
		chip->vooc_strategy1_high2_current  = chip->vooc_strategy_normal_current;
	} else {
		chg_debug("qcom,vooc_strategy1_high2_current is %d\n",
			chip->vooc_strategy1_high2_current);
	}
