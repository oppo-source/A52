...
#include "charger_ic/oppo_battery_sm6125.h"
...
#define OPPO_CHG_1400_CHARGING_CURRENT	1400
...
#define SMART_QC_CHARGER_CELLMODE	0X1002
...
typedef enum {
	...
	BATT_STAT_WARM,
	BATT_STAT_INVALID
} OPPO_CHG_9V2A_TBATT_STATUS;

typedef struct {
	int *batt_temp_thres_addr;
	int default_value;
} batt_temp_zone_info_t;
...
struct oppo_chg_limits {
	...
	int qc_temp_normal_fastchg_ma_higt;
...
/* Liulitian@ODM.BSP.charge, 2020/3/31, for charging current incorrect when vbat is over 4180mV at temp 22~34. */
	bool vbat_4180mv_status_changed;
#endif
};
