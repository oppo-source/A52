...
/*Add by zhongxuejian@Camera 20200310 for flash*/
    ...
    else if (strcmp(vendor_flash_ctrl->flash_name, "pmic") == 0)
    {
        ...
        switch (flash_mode)
        {
            case 0:
                ...
                #ifdef VENDOR_EDIT
                /*modify by Haiyuan.Sun@Camera 20200404, for support 9V/2A  charge flag*/
                set_volt(FALSE);
            ...
            case 1:
                ...
                /*20190513, Setting torch current to 55mA*/
                    /*modify by zhongxuejian@Camera 20200310, for support torch current*/
