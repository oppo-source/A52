	...
	struct msm_sensor_info_t *probed_info, char *entity_name)
{
    ...
    /*XiangYang.Zhang@ODM.Camera.driver, 20191210, add for
    camera driver, set different voltage for camera sensor start*/
    ...
    /*XiangYang.Zhang@ODM.Camera.driver, 20191210, add for
    camera driver, set different voltage for camera sensor end*/
