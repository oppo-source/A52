...
#ifdef VENDOR_EDIT
#huanli.chang@PSW.MM.AudioDriver.Machine,2019/10/16, Add for audio bringup
ifeq ($(call is-board-platform-in-list,msmnile $(TRINKET)),true)
...
#ifdef VENDOR_EDIT
#He.Lu@PSW.MM.AudioDriver.Machine,2019/12/18, Add for homer
ifeq ($(call is-board-platform-in-list,msmnile $(TRINKET)),true)
